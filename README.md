# TP-parte1
#Integrantes:
Joscelyn Agustina Zuñiga
#Tematica: Playlist Musical
#Descripción:
Consiste en un sistema web que permite a los usuarios registrarse, iniciar sesión y gestionar playlists musicales personalizadas. Cada usuario podrá crear y administrar sus propias listas de reproducción, agregando o eliminando canciones según sus preferencias.
